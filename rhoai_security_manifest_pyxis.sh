...
SECURITY SCANNING OPTIONS:
    --pyxis                     Utilize Red Hat's Pyxis API instead of local Syft and Grype scans
...
SECURITY SCANNING EXAMPLES:
    # Generate manifest using Red Hat Pyxis
    $0 --version 2.23.0 --pyxis
