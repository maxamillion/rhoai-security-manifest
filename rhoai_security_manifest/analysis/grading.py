...
class SecurityGrader:
    ...
    def _calculate_security_score(
            ...
            if count > 0:
                try:
                    ...
                    breakdown["vulnerability_penalties"][severity] = {
                        "count": count,
                        "penalty_per_vuln": self.criteria.severity_weights[severity_enum],
        ...
        unpatched_penalty = self._calculate_unpatched_penalty(security_info.vulnerabilities)
    ...
    def get_grade_distribution(
        self,
        graded_containers: List[Tuple[str, SecurityGrade, int, Dict]]
    ) -> Dict[str, int]:
