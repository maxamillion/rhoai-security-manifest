...
class LoggingManager:
    ...
    def _setup_console_handler(
        self, logger: logging.Logger, color_output: bool
    ) -> None:
...
def setup_logging(
    config: Optional[Config] = None, color_output: bool = True, quiet: bool = False
) -> logging.Logger:
    ...
    _logging_manager = LoggingManager(config.logging)
    return _logging_manager.setup_logging(color_output=color_output, quiet=quiet)
